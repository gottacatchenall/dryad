...
function run_neutral_selection()
    ...
    ibm_pop_file::String = "neutral_ibm_pops.csv"
    ibm_genome_file::String = "neutral_ibm_genomes.csv"
    fits_file::String = "neutral_fits.csv"
    ...
    mp::metapop = init_random_metapop(selection_type=@neutral_selection)
    ...
    CSV.write("neutral_ibm_metadata.csv", ibm_metadata)
    CSV.write("neutral_fits_metadata.csv", fits_metadata)
end

run_neutral_selection()
