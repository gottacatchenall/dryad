...
function run_ecological_selection()
    ...
    ibm_pop_file::String = "ecolog_ibm_pops.csv"
    ibm_genome_file::String = "ecolog_ibm_genomes.csv"
    fits_file::String = "ecolog_fits.csv"
    ...
    mp::metapop = init_random_metapop(selection_type=@ecological_selection)
    ...
    CSV.write("ecolog_ibm_metadata.csv", ibm_metadata)
    CSV.write("ecolog_fits_metadata.csv", fits_metadata)
end

run_ecological_selection()
